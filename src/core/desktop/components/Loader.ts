...
export default class Loader{
    ...
    private async init(loadedAssets:(assets:any,app:PIXI.Application)=>void){
        ...
        const manifest = {
            ...
            {
                name:'loading-screen',
                assets: [{name: 'loading',srcs: 'assets/desktop/loading/sprites/loading.json'},]
            },
            {
                name: 'game-screen',
                assets: [
                    {name: 'main',srcs: 'assets/desktop/main/sprites/main.json'},
                    {name: 'controller',srcs: 'assets/desktop/controller/sprites/controller.json'},
                    {name: 'slot',srcs: 'assets/desktop/slot/sprites/slot.json'},
                    {name: 'bonus',srcs: 'assets/desktop/bonus/sprites/bonus.json'},
                    {name: 'modal',srcs: 'assets/desktop/modal/sprites/modal.json'},
                    {name: 'grass',srcs:'assets/desktop/main/sprites/grass.json'},
                    {name: 'pop_glow',srcs: 'assets/desktop/bonus/sprites/pop_glow.json'},
                    {name: 'coins',srcs: 'assets/desktop/pop_ups/sprites/coins.json'},
                    {name: 'transition',srcs: 'assets/desktop/pop_ups/sprites/transition_leaf.json'},
                    {name: 'pop_ups',srcs: 'assets/desktop/pop_ups/sprites/pop-ups.json'},
                    {name: 'congrats',srcs: 'assets/desktop/pop_ups/sprites/congrats.json'},
                    {name: 'frame_glow',srcs: 'assets/desktop/bonus/sprites/frame_glow.json'},
                    {name: 'rock_block',srcs: 'assets/desktop/bonus/sprites/rock_block.json'},
                    {name: 'reel_effect',srcs: 'assets/desktop/bonus/sprites/reel_effect.json'},
                    {name: 'bird',srcs: 'assets/desktop/slot/sprites/bird.json'},
                    {name: 'blue_crystal',srcs: 'assets/desktop/slot/sprites/blue_crystal.json'},
                    {name: 'bonus_symbol',srcs: 'assets/desktop/slot/sprites/bonus.json'},
                    {name: 'cameleon',srcs: 'assets/desktop/slot/sprites/chameleon.json'},
                    {name: 'snake',srcs: 'assets/desktop/slot/sprites/snake.json'},
                    {name: 'violet_crystal',srcs: 'assets/desktop/slot/sprites/violet_crystal.json'},
                    {name: 'monkey',srcs: 'assets/desktop/slot/sprites/monkey.json'},
                    {name: 'leopard',srcs:'assets/desktop/slot/sprites/leopard.json'},
                    {name: 'green_crystal',srcs: 'assets/desktop/slot/sprites/green_crystal.json'},
                    {name: 'orange_crystal',srcs: 'assets/desktop/slot/sprites/orange_crystal.json'},
                    {name: 'wild',srcs: 'assets/desktop/slot/sprites/wild.json'},
                    {name: '2k',srcs: 'assets/desktop/slot/sprites/2k.json'},
                    {name: '3k',srcs: 'assets/desktop/slot/sprites/3k.json'},
                    {name: '5k',srcs: 'assets/desktop/slot/sprites/5k.json'},
                    {name: 'x2',srcs: 'assets/desktop/slot/sprites/x2.json'},
                    {name: 'x3',srcs: 'assets/desktop/slot/sprites/x3.json'},
                    {name: 'x5',srcs: 'assets/desktop/slot/sprites/x5.json'},
                    {name: 'plant_1',srcs: 'assets/desktop/main/sprites/plant_1.json'},
                    {name: 'plant_2',srcs: 'assets/desktop/main/sprites/plant2.json'},
                    {name: 'plant_3',srcs: 'assets/desktop/main/sprites/plant3.json'},
                    {name: 'plant_4',srcs: 'assets/desktop/main/sprites/plant4.json'},
                    {name: 'plant_5',srcs: 'assets/desktop/main/sprites/banana.json'},
                    {name: 'vines',srcs: 'assets/desktop/main/sprites/vines.json'},
