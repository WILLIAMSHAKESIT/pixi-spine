...
export default class Congrats{
    ...
    //text
    public descText:PIXI.Text
    public money:PIXI.Text
    public spins:PIXI.Text
    //value 
    ...
    private createSpins(){
        ...
        this.clickAnyTxt = new PIXI.Text(`click anywhere to continue`, this.textStyle3)
        this.clickAnyTxt.x = (this.overlay.width - this.clickAnyTxt.width)/2
        this.clickAnyTxt.y = (this.overlay.height - this.clickAnyTxt.height)/1.4
        this.middleContainer.addChild(this.clickAnyTxt)
    }
